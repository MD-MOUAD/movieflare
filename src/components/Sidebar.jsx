  ...
  return (
    <div className="max-lg:hidden fixed top-0 left-0 h-screen w-64  dark:text-white bg-slate-200 dark:bg-neutral-950">
      <div className="py-8 flex justify-center border-b-2 border-stone-900/5 dark:border-slate-100/5">
        <h1 className="text-3xl font-bold font-roboto bg-gradient-to-r from-cyan-400 via-sky-900 to-cyan-600 bg-clip-text text-transparent">
          <span className="text-5xl">M</span>ovie
          <span className="text-5xl">l</span>and
        </h1>
      </div>
