...
const CardComponent = ({ item, small }) => {
  if (item.media_type === "person") {
    return (<div className={`${small ? "w-28 sm:w-32 md:w-36 lg:w-40" : "w-28 sm:w-36 md:w-44 lg:w-48 xl:w-52"} shrink-0 rounded-lg overflow-clip relative sm:hover:scale-110 transition-transition duration-300 group aspect-card`}>
      <img
