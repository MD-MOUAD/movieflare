const dayTrendingData = [
    ...
    {
        "backdrop_path": "/qNCB0RqLU4b9S7yqv1aKWzONT2U.jpg",
        "id": 1309923,
        "title": "Non Negotiable",
        "original_title": "No negociable",
        "overview": "Hostage negotiator Alan Bender is called to rescue the president from a kidnapping, only to find himself also mediating to save his wife and marriage.",
    ...
    {
        "backdrop_path": "/eNPpCa7vxO6EYL1Z3H00JoeO4jL.jpg",
        "id": 76669,
        "name": "Elite",
        "original_name": "Élite",
    ...
    {
        "backdrop_path": "/pxw4oHIvDcaLM0PISHhibs2iboe.jpg",
        "id": 249906,
        "name": "Tokyo Swindlers",
        "original_name": "地面師たち",
        "overview": "A team of swindlers gets wind of prime real estate worth 10 billion yen and will stop at nothing to pull off their most ambitious scam yet.",
        "poster_path": "/5NwSIZTfH04UW0VRRQxPcZk3XXm.jpg",
        "media_type": "tv",
        "adult": false,
...
const weekTrendingData = [
    ...
    },
    {
        ...
        "overview": "Within the spectacular, complex and corrupt world of gladiatorial sports in Ancient Rome, follow an ensemble of diverse characters across the many layers of Roman society where sports, politics and business intersect and collide.",
...
const fakeTrendingData = (time) => {
    if (time === "day") {
        return dayTrendingData;
    } else if (time === "week") {
        return weekTrendingData;
    } else {
        return None;
    }
}
